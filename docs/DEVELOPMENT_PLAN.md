...
| 任务 | 状态 | 记录 |
|---|---|---|
| M0-01 展示工程 | 完成 | 2026-09-23 工程骨架、场景目录与 Esc 返回；2026-09-24 增加共用册页框架（印章标题、竖排页签、PageUp/PageDown 切页） |
| M0-02 Windows 导出 | 完成 | .NET SDK 10.0.401 + Godot 4.7.2 .NET；2026-09-24 再次执行 `tools/scripts/export-windows.ps1` 通过（0 警告 0 错误），导出包启动并可进入已完成页面 |
...
| M0-04 人物与战斗画面 | 准备中 | 人物样板归家用台式机生成；先用一位人物验证立绘、探索和战斗形象的一致性 |
| M0-05 主要 UI | 进行中，4 / 11 页 | 已完成：角色 / 武学 / 成长，背包 / 装备 / 商店，任务 / 关系 / 见闻，暂停 / 设置；1080p、1440p 截图自查布局与文字。待制作：主菜单、大地图、对话（依赖背景与立绘），以及三类探索与战斗页的 HUD |
