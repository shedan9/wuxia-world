...
public static class PreviewPages
{
    ...
    [
        ...
        new("preview.explore_town", "城镇 / 街道探索", "斜俯视、建筑比例、人物大小、探索 HUD", "res://scenes/preview/ExploreTown.tscn"),
        new("preview.explore_inn", "客栈 / 室内探索", "遮挡、室内构图、近景材质与灯光", "res://scenes/preview/ExploreInn.tscn"),
        new("preview.explore_hud", "探索 HUD（界面层）", "地点、目标追踪、小地图、交互提示与通知", "res://scenes/preview/ExploreHud.tscn"),
        new("preview.explore_wild", "山路 / 野外探索", "植被、山石、前后层次与路径辨识", "res://scenes/preview/ExploreWild.tscn"),
